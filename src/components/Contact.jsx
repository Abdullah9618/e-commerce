// ...existing code...
import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaFacebookF, FaWhatsapp, FaTiktok } from "react-icons/fa";
import { useState } from "react";
// Font Awesome icons are used for all social links below
          ...
          <div className="md:w-1/2 flex flex-col justify-start p-8 rounded-xl shadow-lg bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 text-white">
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center">
                ...
                <a className="hover:underline" href="tel:+923454133349">+92 345 4133349</a>
              </p>
              <p className="mt-6">
            ...
            <div className="flex gap-4 mt-8">
              <a href="https://www.facebook.com/SubhanArtsPk" target="_blank" rel="noreferrer" className="text-white hover:text-yellow-300 transition text-2xl">
                <FaFacebookF />
              </a>
              ...
              <a href="https://vm.tiktok.com/ZSHE4p5AR12D8-HbKRj/" target="_blank" rel="noreferrer" className="text-white hover:text-yellow-300 transition text-2xl">
                <FaTiktok />
              </a>
            </div>
          </div>
